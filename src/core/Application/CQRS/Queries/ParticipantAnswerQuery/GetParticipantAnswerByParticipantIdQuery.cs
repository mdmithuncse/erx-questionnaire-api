...
{
    public class GetParticipantAnswerByParticipantIdQuery : IRequest<PagedResult<ParticipantAnswerResponse>>
    {
        public int Page { get; set; }
        public int PageSize { get; set; }
        public long ParticipantId { get; set; }

        public class GetParticipantAnswerByParticipantIdQueryHandler : IRequestHandler<GetParticipantAnswerByParticipantIdQuery, PagedResult<ParticipantAnswerResponse>>
        {
            ...
            public async Task<PagedResult<ParticipantAnswerResponse>> Handle(GetParticipantAnswerByParticipantIdQuery query, CancellationToken cancellationToken)
            {
                var result = await _context.ParticipantAnswers.Where(x => x.ParticipantId == query.ParticipantId).GetPagedItemsAsync(query.Page, query.PageSize);
